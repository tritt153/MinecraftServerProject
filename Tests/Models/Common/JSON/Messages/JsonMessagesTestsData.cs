...
using static MinecraftServerTests.Models.Common.JSON.Events.JsonEventsTestsData;
using static MinecraftServerTests.Test_Utilities.Constants;

namespace MinecraftServerTests.Models.Common.JSON.Messages
{
    public static class JsonMessagesTestsData
    {
        #region Json Message Segment
        ...
        public class JsonMessageSegmentTestsData : ITestFactory<JsonMessageSegment>
        {
            ...
            public static JsonMessageSegment FullyInitalizedObject
            {
                get
                {
                    JsonClickEvent oClickEvent = JsonClickEventTestsData.GetMinimalValidInstance();
                    JsonHoverEvent oHoverEvent = JsonHoverEventTestsData.GetMinimalValidInstance();
            ...
            public static JsonMessageSegment GetMinimalValidInstance()
            {
                return new JsonMessageSegment(VALID_STRING_INPUT);
            }
        ...
        #endregion // Json Message Segment
        ...
        public class JsonMessageTestsData : ITestFactory<JsonMessage>
        {
            ...
            /// </summary>
            /// <returns>A minimally valid instance of <see cref="JsonMessageSegment"/></returns>
            public static JsonMessage GetMinimalValidInstance()
            {
                return new JsonMessage(JsonMessageSegmentTestsData.GetMinimalValidInstance());
            }

            #endregion // ITestFactory
        }

        #endregion // Json Message
    }
}
