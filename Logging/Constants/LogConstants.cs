namespace MinecraftServer.Logging.Constants
{
    internal static class LogConstants
    {
        ...
        /// </summary>
        internal const string LOG_MESSAGE_REGULAR_FORMAT = "{0}: {1} --- [FILE: {2}, METHOD: {3}, LINE: {4}] --> {5}";

        /// <summary>
        /// Constant that holds format for exception log messages
        /// </summary>
        internal const string LOG_MESSAGE_EXCEPTION_FORMAT = "{0}: {1} --- [FILE: {2}, METHOD: {3}, LINE: {4}] --> EXCEPTION: {5}";
