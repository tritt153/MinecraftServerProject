...
namespace MinecraftServer.Common.General
{
    public static class Validator
    {
        ...
        public static void ValidateParams([NotNull] params IValidatable[] oParams)
        {
            CheckNull(oParams);
            ...
            for (int nParameterIndex = 0; nParameterIndex < oParams.Length; nParameterIndex++)
            {
                ...
                ValidateParam(oParams[nParameterIndex], sParamName);
            }
        }
        ...
        public static void ValidateString([NotNull] string sValue, 
                                          ...
                                          [CallerArgumentExpression(nameof(sValue))] string sParamName = "")
        {
            ...
            {
                StringValidator.CheckNullOrEmpty(sValue, sMessage, sParamName);
            }

            if (eOptions.HasFlag(eStringValidationOptions.NotWhiteSpace))
            {
                StringValidator.CheckNullOrWhiteSpace(sValue, sMessage, sParamName);
            }
        }
