...
namespace MinecraftServer.Common.Data_Validation
{
    public static class Thrower
    {
        ...
        [DoesNotReturn]
        public static void ThrowEmptyStringException(string sMessage, string sParamName)
        {
            throw new ArgumentException(sMessage, sParamName);
        }

        [DoesNotReturn]
        public static void ThrowWhiteSpaceStringException(string sMessage, string sParamName)
        {
            throw new ArgumentException(sMessage, sParamName);
        }
